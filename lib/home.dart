  ...
  List<Map<String, dynamic>> _filters = [
    ...
    },
    {
      ...
      'child': [
        ...
        {'label': '€100 - €150', 'value': false, 'min': 100, 'max': 149},
        {
          'label': '€150 et plus',
          'value': false,
          'min': 150,
    ...
    },
    {
      ...
      'field': 'sport',
      'child': [
        {'label': 'Football', 'value': false, 'realValue': 'Football'},
        {'label': 'Basketball', 'value': false, 'realValue': 'Basket'},
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('$_imageLink/${produit['photo']}'),
                  fit: BoxFit.cover,
                ),
              ),
              child: null,
          ...
          .where((el) =>
              (noFilter ||
                  ((filter['sexe'].isEmpty
                      ...
                      (filter['sport'].isEmpty
                          ? true
                          : filter['sport'].contains(
                              el['sport'].toString().toLowerCase())) &&
                      (filter['couleur'].isEmpty
                          ? true
                          : filter['couleur']
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                if (constraints.maxWidth < 1366)
                                  IconButton(
                                    onPressed: () async {
                                      final val = await _showFullModal(
                                          context, _filters);
                                      if (val != null) {
                                        setState(() {
                                          _filters = val;
                          ...
                          _produitsSearched.isEmpty
                              ...
                              : Expanded(
                                  child: GridView.builder(
                                    ...
                                    itemCount: _produitsSearched.length,
                                    itemBuilder: ((context, index) {
                                      final produit = _produitsSearched[index];
                                      return _buildItem(produit);
                                    }),
                                  ),
                                ),
                          // : Expanded(
